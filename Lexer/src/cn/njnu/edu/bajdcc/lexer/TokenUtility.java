...
public class TokenUtility {
	...
	public static enum TokenID {
		// 关键字
		AUTO, BOOL, BREAK, CASE, CHAR, CLASS, CONST, CONTINUE, DEFAULT, DELETE, DO, DOUBLE, ELSE, ENUM, EXTERN, FALSE, FLOAT, FOR, GOTO, IF, INT, LONG, MUTABLE, NAMESPACE, NEW, PRIVATE, PROTECTED, PUBLIC, REGISTER, RETURN, SIGNED, SIZEOF, STATIC, STRUCT, SWITCH, TRUE, TYPEDEF, UNION, UNSIGNED, USING, VAR, VOID, VOLATILE, WHILE,

		// 操作符
		ASSIGN /* = */, PLUS /* + */, MINUS /* - */, TIMES /* * */, DIV /* / */, MOD /* % */, BIT_AND /* & */, BIT_OR /* | */, BIT_NOT /* ~ */, LOG_NOT /* ! */, LT /* < */, GT /* > */,

		// 标点符号
		LPARAN /* ( */, RPARAN /* ) */, LBRACE /* { */, RBRACE /* } */, LSQUARE /* [ */, RSQUARE /* ] */, COMMA /* , */, DOT /* . */, SEMI /* ; */, COLON /* : */,

		// 二元操作符
		EQ /* == */, NEQ /* != */, PLUS_PLUS /* ++ */, MINUS_MINUS /* -- */, PLUS_ASSIGN /* += */, MINUS_ASSIGN /* -= */, TIMES_ASSIGN /* *= */, DIV_ASSIGN /* /= */, NGT /* <= */, NLT /* >= */, LOGICAL_AND /* && */, LOGICAL_OR /* || */,
	};

	/**
	 * 类型
	 */
	private static String[] arrTypes = { "signed", "unsigned", "char", "bool",
	 ...
	 * 运算符
	 */
	private static String[] arrOperators = { "=", "+", "-", "*", "/", "%", "&",
			"|", "~", "!", "<", ">", "(", ")", "{", "}", "[", "]", ",", ".",
			";", ":", "==", "!=", "++", "--", "+=", "-=", "*=", "/=", "<=",
			">=", "&&", "||" };
